...
4. Dans SonarQube, cree un webhook vers `http://jenkins:8080/sonarqube-webhook/` si tu souhaites aussi utiliser le plugin Jenkins. Le pipeline du repo sait cependant verifier la Quality Gate directement via l'API SonarQube.
5. Dans Nexus, cree un repository npm hosted nomme `npm-releases`.
